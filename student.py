...
class Student:
    ...
    # This part is image labels setting start 
        ...
        #title section
        title_lb1 = Label(bg_img,text="Welcome",font=("verdana",30,"bold"),bg="white",fg="navyblue")
        ...
        # Left Label Frame 
        left_frame = LabelFrame(main_frame,bd=2,bg="white",relief=RIDGE,text="Details",font=("verdana",12,"bold"),fg="navyblue")
        ...
        dep_combo["values"]=("Select Department","MSc","MCom","BSc","BCom","MBA","PhD")
        dep_combo.current(0)
        ...
        cou_combo["values"]=("Select Course","CS","MicroBio","BioChem","Finance","Physics")
        cou_combo.current(0)
        ...
        #----------------------------------------------------------------------
        # Right Label Frame 
        right_frame = LabelFrame(main_frame,bd=2,bg="white",relief=RIDGE,text="",font=("verdana",12,"bold"),fg="navyblue")
        ...
        #create table 
        self.student_table = ttk.Treeview(table_frame,column=("ID","Name","Dep","Course","Year","Sem","Gender","DOB","Mob-No","Address","Roll-No","Email","Photo"),xscrollcommand=scroll_x.set,yscrollcommand=scroll_y.set)
...
# ==================Function Decleration==============================
    def add_data(self):
        if self.var_dep.get()=="Select Department" or self.var_course.get=="Select Course" or self.var_year.get()=="Select Year" or self.var_semester.get()=="Select Semester" or self.var_std_id.get()=="" or self.var_std_name.get()==""or self.var_roll.get()=="" or self.var_gender.get()=="" or self.var_dob.get()=="" or self.var_email.get()=="" or self.var_mob.get()=="" or self.var_address.get()=="":
        ...
        if self.var_dep.get()=="Select Department" or self.var_course.get=="Select Course" or self.var_year.get()=="Select Year" or self.var_semester.get()=="Select Semester" or self.var_std_id.get()=="" or self.var_std_name.get()==""  or self.var_roll.get()=="" or self.var_gender.get()=="" or self.var_dob.get()=="" or self.var_email.get()=="" or self.var_mob.get()=="" or self.var_address.get()=="":
            ...
            try:
                ...
                if Update > 0:
                    conn = mysql.connector.connect(username='root',host='localhost',database='face_recognition',port=3306,password="project")
                    mycursor = conn.cursor()
                    mycursor.execute("update student set Name=%s,Department=%s,Course=%s,Year=%s,Semester=%s,Gender=%s,DOB=%s,Mobile_No=%s,Address=%s,Roll_No=%s,Email=%s,PhotoSample=%s where Student_ID=%s",( 
                    self.var_std_name.get(),
                    self.var_dep.get(),
                    self.var_course.get(),
                    self.var_year.get(),
    ...
    def search_data(self):
        if self.var_search.get()=="" or self.var_searchTX.get()=="Select":
            ...
            try:
                ...
                sql = "SELECT Student_ID,Name,Department,Course,Year,Semester,Gender,DOB,Mobile_No,Address,Roll_No,Email,PhotoSample FROM student where Roll_No='" +str(self.var_search.get()) + "'" 
