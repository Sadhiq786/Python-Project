...
class Login:
    def __init__(self,root):
        ...
        self.bg=ImageTk.PhotoImage(file=r"E:\Face_Recognition\Images_GUI\loginBg1.jpg")
        ...
        img1=Image.open(r"E:\Face_Recognition\Images_GUI\log1.png")
        img1=img1.resize((100,100),Image.ANTIALIAS)
        self.photoimage1=ImageTk.PhotoImage(img1)
        lb1img1 = Label(image=self.photoimage1,bg="#002B53")
        lb1img1.place(x=620,y=175, width=100,height=100)
        ...
        loginbtn.place(x=90,y=370,height=20)
    ...
    def login(self):
        if self.txtuser.get()=="" and self.txtpwd.get()=="":
            messagebox.showerror("Error","All Fields Required!")
        elif self.txtuser.get()=="admin" and self.txtpwd.get()=="admin":
            messagebox.showinfo("Sussessfully","Welcome")
        else:
            try:
                # messagebox.showerror("Error","Please Check Username or Password !")
                conn = mysql.connector.connect(username='root', password="project",host='localhost',database='face_recognition',port=3306)
                ...
                if row is None:
                    ...
                    open_min=messagebox.askyesno("YesNo","Access only to the Admin")
                    if open_min>0:
                        self.new_window=Toplevel(self.root)
...
class Register:
    def __init__(self,root):
        ...
        self.bg=ImageTk.PhotoImage(file=r"E:\Face_Recognition\Images_GUI\bgReg.jpg")
        
        lb1_bg=Label(self.root,image=self.bg)
        lb1_bg.place(x=0,y=0, relwidth=1,relheight=1)

        frame= Frame(self.root,bg="#F2F2F2")
        frame.place(x=220,y=60,width=900,height=600)
        

        get_str = Label(frame,text="Registration",font=("times new roman",30,"bold"),fg="#002B53",bg="#F2F2F2")
        get_str.place(x=350,y=45)
        ...
        loginbtn.place(x=103,y=488,width=270,height=35)

        # Creating Button Login
        loginbtn=Button(frame,text="Login",command=self.return_login,font=("times new roman",15,"bold"),bd=0,relief=RIDGE,fg="#fff",bg="#002B53",activeforeground="white",activebackground="#007ACC")
        loginbtn.place(x=533,y=488,width=270,height=35)
    ...
    def reg(self):
        if (self.var_fname.get()=="" or self.var_lname.get()=="" or self.var_cnum.get()=="" or self.var_email.get()=="" or self.var_ssq.get()=="Select" or self.var_sa.get()=="" or self.var_pwd.get()=="" or self.var_cpwd.get()==""):
            ...
            try:
                conn = mysql.connector.connect(username='root',host='localhost',database='face_recognition',port=3306,password="project")
                mycursor = conn.cursor()
                query=("select * from regteach where email=%s")
...
# This part is image labels setting start 
        ...
        # backgorund image 
        bg1=Image.open(r"E:\Face_Recognition\Images_GUI\bg3.jpg")
        ...
        #title section
        title_lb1 = Label(bg_img,text="Authentication Using Face Recognition",font=("verdana",25,"bold"),bg="white",fg="navyblue")
        ...
        lbl = Label(title_lb1,font=('times new roman',18,'bold'),background='white',foreground='navyblue')
        lbl.place(x=120,y=-3,width=150,height=50)
        time()
        ...
        # ------------------------------------------------------------------------------------------------------------------- 
        # student button 1
        std_img_btn=Image.open(r"E:\Face_Recognition\Images_GUI\std1.jpg")
        ...
        std_b1_1 = Button(bg_img,command=self.student_pannels,text="Details",cursor="hand2",font=("tahoma",15,"bold"),bg="white",fg="navyblue")
        std_b1_1.place(x=250,y=280,width=180,height=45)

        # Detect Face  button 2
        det_img_btn=Image.open(r"E:\Face_Recognition\Images_GUI\det1.jpg")
        ...
        att_img_btn=Image.open(r"E:\Face_Recognition\Images_GUI\att.jpg")
        ...
        hlp_img_btn=Image.open(r"E:\Face_Recognition\Images_GUI\hlp.jpg")
        ...
        # Start below buttons.........
         # Train   button 5
        tra_img_btn=Image.open(r"E:\Face_Recognition\Images_GUI\tra1.jpg")
        ...
        # Photo   button 6
        pho_img_btn=Image.open(r"E:\Face_Recognition\Images_GUI\cam.jpg")
        ...
        pho_b1_1 = Button(bg_img,command=self.open_img,text="Data",cursor="hand2",font=("tahoma",15,"bold"),bg="white",fg="navyblue")
        pho_b1_1.place(x=480,y=510,width=180,height=45)

        # Developers   button 7
        dev_img_btn=Image.open(r"E:\Face_Recognition\Images_GUI\dev.jpg")
        ...
        # exit   button 8
        exi_img_btn=Image.open(r"E:\Face_Recognition\Images_GUI\exi.jpg")
